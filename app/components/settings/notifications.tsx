    ...
    <>
      <div className="flex items-center justify-between p-4 border-b dark:border-neutral-700">
        <div className="flex items-center">
          ...
          <h4 className="ml-2 font-semibold text-gray-700 dark:text-neutral-100">Notifications</h4>
        </div>
      ...
      <div className="p-4">
        <p className="text-sm text-gray-700 dark:text-neutral-300">Update your notification preferences.</p>
      </div>
    </>
  )
}