    ...
    <>
      <div className="flex items-center justify-between p-4 border-b dark:border-neutral-700">
        <div className="flex items-center">
          <div className="w-10 h-10 rounded-full bg-gray-200 text-gray-800 flex justify-center items-center text-lg"><i className="ri ri-user-line"></i></div>
          <h4 className="ml-2 font-semibold text-gray-700 dark:text-neutral-100">Personal Information</h4>
        </div>
      ...
      <div className="p-4">
        <p className="text-sm text-gray-700 dark:text-neutral-300">Update your personal information such as name, email, and profile picture.</p>
      </div>
    </>
  )
}