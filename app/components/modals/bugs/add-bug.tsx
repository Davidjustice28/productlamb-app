  ...
  return (
    <PLBaseModal open={open} onClose={onClose} title="Add Bug" setOpen={setOpen}>
      <Form className="relative p-6 flex-auto rounded px-8 pt-6 pb-2 w-full" method="POST" ref={formRef}>
        ...
        <label className="block text-sm font-medium text-gray-700 dark:text-neutral-300 mt-4">Status</label>
        <select name="status" className="p-2 text-black dark:text-neutral-400 mt-1 block w-full border-2 dark:bg-transparent dark:border-neutral-700 border-gray-300 rounded-md shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 sm:text-sm">
