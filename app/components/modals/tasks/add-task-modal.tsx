  ...
  return (
    <PLBaseModal open={open} onClose={onClose} title="Add task to sprint" setOpen={setOpen}>
      <form className="relative p-6 flex-auto rounded px-8 pt-6 pb-2 w-full flex flex-col gap-2" method="POST" ref={formRef}>
        ...
        <input name="points" type="number" min={1} defaultValue={4} max={4} className="shadow appearance-none border rounded w-full py-2 px-3 text-neutral-800 dark:text-neutral-200 leading-tight focus:outline-none focus:shadow-outline border-gray-300 dark:bg-transparent dark:border-neutral-700"></input>
