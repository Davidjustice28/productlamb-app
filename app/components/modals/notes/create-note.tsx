  ...
  return (
    <PLBaseModal open={open} onClose={onClose} title="Create Note" setOpen={setOpen}>
      <form className="relative p-6 flex-auto rounded px-8 pt-6 pb-2 w-full" method="POST" ref={formRef}>
        ...
        <textarea name="note" maxLength={100} className="shadow appearance-none border rounded w-full py-2 px-3 text-neutral-800 dark:text-neutral-200 leading-tight focus:outline-none focus:shadow-outline border-gray-300 dark:bg-transparent dark:border-neutral-700 resize-none" id="feedback"/>
