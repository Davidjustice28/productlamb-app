...
export function PLIntegrationOption({ integration, addMode=false}: { integration: any, addMode?: boolean }) {
        ...
        <div className="flex items-center gap-2 group">
          {
            addMode ?
            <>
              <button className="p-2 text-gray-600 rounded-full dark:text-neutral-300 hover:bg-gray-100 dark:hover:bg-neutral-700" aria-label="Options">
